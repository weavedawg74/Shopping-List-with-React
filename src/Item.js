...
export default function Item( {item, toggleItem, deleteItem, editItem} ) {
    ...
    const itemToAdd = (<p className ="listItem d-inline-flex align-items-center flex-wrap w-100">{checkbox}{itemName}{editBtn}{deleteBtn}</p>
    );
    return (
